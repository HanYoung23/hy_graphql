...
// import 'package:letsgotrip/_Controller/nickname_controller.dart';
...
//   NicknameContoller nicknameContoller = Get.put(NicknameContoller());
//   NicknameContoller isValidNickname = Get.find();
//   NicknameContoller isVisible = Get.find();
//   NicknameContoller preNickname = Get.find();
...
//                           isAllFilled = false;
//                           isQuery = false;
//                           isValidNickname.isVisible(false);
//                         });
//                       },
...
//                               // });
//                               // setState(() {});
//                               isValidNickname.isVisible(true);
//                               isValidNickname
//                                   .updatePreNickname(nicknameController.text);
//                               FocusScope.of(context).unfocus();
//                             }
//                           },
//                           child: Container(
...
//                                     ScreenUtil().setSp(5)),
//                                 color:
//                                     isValid ? app_blue : app_blue_light_button),
//                             child: Center(
//                                 child: Text(
//                               "적용",
//                               style: TextStyle(
...
//                           if (!result.isLoading) {
//                             print(
//                                 "🚨 result : ${result.data["check_nickname"]}");
//                             print("🚨 nickname : ${nicknameController.text} ");

//                             // print("🚨 notice : ${result.data}");
//                             String message = "";
//                             if (result.data["check_nickname"]["result"]) {
...
//                                 //   isAllFilled = true;
//                                 // });
//                                 // isValidNickname.isValidNickname.value(true);
//                                 if ("${preNickname.preNickname.value}" !=
//                                     "${nicknameController.value}") {
//                                   nicknameContoller.updateIsValidNickname(true);
//                                 }
//                               });
//                             } else {
...
//                                 //   isAllFilled = false;
//                                 // });
//                                 // isValidNickname.isValidNickname.value(false);
//                                 if ("${preNickname.preNickname.value}" !=
//                                     "${nicknameController.value}") {
//                                   nicknameContoller
//                                       .updateIsValidNickname(false);
//                                 }
//                               });
//                             }
//                             return Text(message,
...
//                         decoration: BoxDecoration(
//                             color: isValidNickname.isValidNickname.value &&
